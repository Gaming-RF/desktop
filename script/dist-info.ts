...
export function getLinuxTarName() {
  return `${productName}-${getDistArchitecture()}.tar.gz`
}

export function getLinuxTarPath() {
  return Path.join(getDistPath(), '..', getLinuxTarName())
}
